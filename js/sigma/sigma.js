...
(function () {
    Array.prototype.some ||
        (Array.prototype.some = function (g, n) {
            var i = this.length;
            if ('function' != typeof g) throw new TypeError();
            for (var k = 0; k < i; k++)
                if (k in this && g.call(n, this[k], k, this)) return !0;
            return !1;
        });
    Array.prototype.forEach ||
        (Array.prototype.forEach = function (g, n) {
            var i = this.length;
            if (typeof g != 'function') throw new TypeError();
            for (var k = 0; k < i; k++)
                k in this && g.call(n, this[k], k, this);
        });
    Array.prototype.map ||
        (Array.prototype.map = function (g, n) {
            var i = this.length;
            if (typeof g != 'function') throw new TypeError();
            for (var k = Array(i), o = 0; o < i; o++)
                o in this && (k[o] = g.call(n, this[o], o, this));
            return k;
        });
    Array.prototype.filter ||
        (Array.prototype.filter = function (g, n) {
            var i = this.length;
            if (typeof g != 'function') throw new TypeError();
            for (var k = [], o = 0; o < i; o++)
                if (o in this) {
...
(function () {
    ...
    function n() {
        ...
        this.addNode = function (d, b) {
            if (c.nodesIndex[d])
                throw Error('Node "' + d + '" already exists.');
            var b = b || {},
                a = {
                    x: 0,
                    y: 0,
        ...
        this.addNodeBG = function (d, b) {
            if (c.nodesBGIndex[d])
                throw Error('NodeBG "' + d + '" already exists.');
            var b = b || {},
                a = {
                    x: 0,
                    y: 0,
        ...
        this.addEdge = function (d, b, a, f) {
            if (c.edgesIndex[d])
                throw Error('Edge "' + d + '" already exists.');
            if (!c.nodesIndex[b])
                throw Error('Edge\'s source "' + b + '" does not exist yet.');
            if (!c.nodesIndex[a])
                throw Error('Edge\'s target "' + a + '" does not exist yet.');
            f = f || {};
            b = {
            ...
            ((b instanceof Array ? b : [b]) || []).forEach(function (b) {
                if (c.nodesIndex[b]) {
                    ...
                    c.edges = c.edges.filter(function (a) {
                        return a.source.id == b
                            ? (delete c.edgesIndex[a.id],
                              a.target.degree--,
                              a.target.inDegree--,
                              !1)
                            : a.target.id == b
        ...
        this.rescale = function (b, h, a, f, i) {
            ...
            var u =
                    'outside' == c.p.scalingMode
                        ? g.max(b / g.max(q - v, 1), h / g.max(w - A, 1))
                        : g.min(b / g.max(q - v, 1), h / g.max(w - A, 1)),
                u = u - u / 20,
                x,
                k;
            !c.p.maxNodeSize && !c.p.minNodeSize
                ? ((x = 1), (k = 0))
                : c.p.maxNodeSize == c.p.minNodeSize
                ? ((x = 0), (k = c.p.maxNodeSize))
                : ((x = (c.p.maxNodeSize - c.p.minNodeSize) / m),
                  (k = c.p.minNodeSize));
            var p, r;
            !c.p.maxEdgeSize && !c.p.minEdgeSize
                ...
                : ((p =
                      c.p.maxEdgeSize == c.p.minEdgeSize
                          ? 0
                          : (c.p.maxEdgeSize - c.p.minEdgeSize) / l),
                  (r = c.p.minEdgeSize));
            a &&
                c.nodes.forEach(function (a) {
            ...
            i &&
                c.nodesBG.forEach(function (a) {
                    a.displaySize =
                        a.size * g.sqrt(sigInst._core.mousecaptor.ratio * u);
                    if (!a.fixed) {
                        a.displayX = (a.x - (q + v) / 2) * u + b / 2;
                        a.displayY = (a.y - (w + A) / 2) * u + h / 2;
                    }
        ...
        this.translate = function (b, h, a, f, i, g) {
            ...
            f &&
                c.nodes.forEach(function (c) {
                    c.fixed ||
                        ((c.displayX = c.displayX * a + b),
                        (c.displayY = c.displayY * a + h));
                    c.displaySize *= m;
                });
            g &&
                c.nodesBG.forEach(function (c) {
                    c.fixed ||
                        ((c.displayX = c.displayX * a + b),
                        (c.displayY = c.displayY * a + h));
                    c.displaySize *= m;
        ...
        this.checkHover = function (b, h) {
            ...
            c.nodes.forEach(function (c) {
                if (c.hidden) c.hover = !1;
                    ...
                    v && !k
                        ? ((c.hover = !1), m.push(c.id))
                        : k && !v && ((c.hover = !0), g.push(c.id));
                }
            });
    ...
    function i(b, i) {
        function h() {
            var b;
            b = '<p>GLOBAL :</p>';
            for (var h in c.p.globalProbes)
                b += '<p>' + h + ' : ' + c.p.globalProbes[h]() + '</p>';
            b += '<br><p>LOCAL :</p>';
            for (h in c.p.localProbes)
                b += '<p>' + h + ' : ' + c.p.localProbes[h]() + '</p>';
            c.p.dom.innerHTML = b;
            return c;
        }
        sigma.classes.Cascade.call(this);
        ...
        this.activate = function () {
            c.monitoring ||
                (c.monitoring = window.setInterval(h, 1e3 / c.p.fps));
            return c;
        };
    ...
    function k(b) {
        function i(a) {
            f.mouseX =
                ...
                (void 0 != a.layerX && a.layerX) ||
                (void 0 != a.clientX && a.clientX);
            f.mouseY =
                (void 0 != a.offsetY && a.offsetY) ||
                (void 0 != a.layerY && a.layerY) ||
                (void 0 != a.clientY && a.clientY);
            if (f.isMouseDown) {
                var b = f.mouseX - k + m,
                    c = f.mouseY - l + j;
                if (b != f.stageX || c != f.stageY)
                    (w = A),
                        (x = u),
                        (A = b),
                        (u = c),
        ...
        function h(a) {
            f.p.mouseEnabled &&
                ...
                ((f.isMouseDown = !1),
                f.dispatch('mouseup'),
                (m != f.stageX || j != f.stageY) &&
                    g(
                        f.stageX + f.p.inertia * (f.stageX - w),
                        f.stageY + f.p.inertia * (f.stageY - x)
                    ),
                a.preventDefault ? a.preventDefault() : (a.returnValue = !1));
        }
        function c(a) {
        ...
        function d(a) {
            f.p.mouseEnabled &&
                (g(
                    ...
                    f.ratio *
                        (0 <
                        ((void 0 != a.wheelDelta && a.wheelDelta) ||
                            (void 0 != a.detail && -a.detail))
                            ? f.p.zoomMultiply
                            : 1 / f.p.zoomMultiply)
                ),
                f.p.blockScroll &&
        ...
        function g(b, c, d) {
            if (
                !f.isMouseDown &&
                (window.clearInterval(f.interpolationID),
                (p = void 0 != d),
                (m = f.stageX),
                (y = b),
                (j = f.stageY),
                (q = c),
                (n = d || f.ratio),
                (n = Math.min(Math.max(n, f.p.minRatio), f.p.maxRatio)),
                (B = f.p.directZooming
                    ? 1 - (p ? f.p.zoomDelta : f.p.dragDelta)
                    : 0),
                f.ratio != n || f.stageX != y || f.stageY != q)
            )
                a(),
                    (f.interpolationID = window.setInterval(a, 50)),
                    f.dispatch('startinterpolate');
        }
        function a() {
            ...
            f.ratio = b * (1 - a) + n * a;
            p
                ? ((f.stageX = y + ((f.stageX - y) * f.ratio) / b),
                  (f.stageY = q + ((f.stageY - q) * f.ratio) / b))
                : ((f.stageX = m * (1 - a) + y * a),
                  (f.stageY = j * (1 - a) + q * a));
            ...
            1 <= B &&
                ...
                p
                    ? ((f.ratio = n),
                      (f.stageX = y + ((f.stageX - y) * f.ratio) / a),
                      (f.stageY = q + ((f.stageY - q) * f.ratio) / a))
                    : ((f.stageX = y), (f.stageY = q)),
                f.dispatch('stopinterpolate'));
        }
        sigma.classes.Cascade.call(this);
        sigma.classes.EventDispatcher.call(this);
        var f = this;
        ...
        this.isMouseDown = !1;
        b.addEventListener && document.addEventListener
            ? (b.addEventListener('DOMMouseScroll', d, !0),
              b.addEventListener('mousewheel', d, !0),
              b.addEventListener('mousemove', i, !0),
              b.addEventListener('mousedown', c, !0),
              document.addEventListener('mouseup', h, !0))
            : (b.attachEvent('onDOMMouseScroll', d),
              b.attachEvent('onmousewheel', d),
              b.attachEvent('onmousemove', i),
              b.attachEvent('onmousedown', c),
    ...
    function o(b, i, h, c, d, g, a, f, k) {
        function l(a) {
            var b = c,
                ...
                f =
                    'fixed' == j.p.labelSize
                        ...
                        : j.p.labelSizeRatio * a.displaySize;
            b.font =
                (j.p.hoverFontStyle || j.p.fontStyle || '') +
                ' ' +
                f +
                'px ' +
                (j.p.hoverFont || j.p.font || '');
            b.fillStyle =
                'node' == j.p.labelHoverBGColor
                    ? a.color || j.p.defaultNodeColor
                    : j.p.defaultHoverLabelBGColor;
            j.p.labelHoverShadow &&
                ((b.shadowOffsetX = 0),
                (b.shadowOffsetY = 0),
                (b.shadowBlur = 4),
                (b.shadowColor = j.p.labelHoverShadowColor));
            ...
            b.shadowBlur = 0;
            b.fillStyle =
                'node' == j.p.labelHoverColor
                    ? a.color || j.p.defaultNodeColor
                    : j.p.defaultLabelHoverColor;
        ...
        function m(a) {
            if (isNaN(a.x) || isNaN(a.y))
                throw Error(
                    "A node's coordinate is not a number (id: " + a.id + ')'
                );
            return (
                !a.hidden &&
                a.displayX + a.displaySize > -n / 3 &&
                a.displayX - a.displaySize < (4 * n) / 3 &&
                a.displayY + a.displaySize > -y / 3 &&
                a.displayY - a.displaySize < (4 * y) / 3
            );
        }
        sigma.classes.Cascade.call(this);
        var j = this;
        ...
        this.task_drawLabel = function () {
            for (
                ...
                c++ < j.p.labelsSpeed && j.currentLabelIndex < b;
                ...
                if (j.isOnScreen(a.nodes[j.currentLabelIndex])) {
                    ...
                    if (d.displaySize >= j.p.labelThreshold) {
                        var g =
                            'fixed' == j.p.labelSize
                                ? j.p.defaultLabelSize
                                : j.p.labelSizeRatio * d.displaySize;
                        f.font =
                            (j.p.hoverFontStyle || j.p.fontStyle || '') +
                            ' ' +
                            g +
        ...
        this.task_drawEdge = function () {
            for (
                var b = a.edges.length, c, d, f = 0, h;
                f++ < j.p.edgesSpeed && j.currentEdgeIndex < b;

            )
                if (
                    ((h = a.edges[j.currentEdgeIndex]),
                    (c = h.source),
                    (d = h.target),
                    h.hidden ||
                        c.hidden ||
                        d.hidden ||
                        (!j.isOnScreen(c) && !j.isOnScreen(d)))
                )
                    j.currentEdgeIndex++;
                else {
        ...
        this.task_drawNode = function () {
            for (
                var b = a.nodes.length, c = 0;
                c++ < j.p.nodesSpeed && j.currentNodeIndex < b;

            )
                j.isOnScreen(a.nodes[j.currentNodeIndex])
                    ? j.drawNode(a.nodes[j.currentNodeIndex++])
                    : j.currentNodeIndex++;
            return j.currentNodeIndex < b;
        };
        this.task_drawBG = function () {
            for (
                var b = a.nodesBG.length, c = 0;
                c++ < j.p.nodesBGSpeed && j.currentBGIndex < b;

            )
                j.drawBG(a.nodesBG[j.currentBGIndex++]);
        ...
        this.drawActiveNode = function (a) {
            ...
            var d =
                'fixed' == j.p.labelSize
                    ...
                    : j.p.labelSizeRatio * a.displaySize;
            b.font =
                (j.p.activeFontStyle || j.p.fontStyle || '') +
                ' ' +
                d +
                'px ' +
                (j.p.activeFont || j.p.font || '');
            b.fillStyle =
                'node' == j.p.labelHoverBGColor
                    ? a.color || j.p.defaultNodeColor
                    : j.p.defaultActiveLabelBGColor;
            b.beginPath();
            j.p.labelActiveShadow &&
                ((b.shadowOffsetX = 0),
                (b.shadowOffsetY = 0),
                (b.shadowBlur = 4),
                (b.shadowColor = j.p.labelActiveShadowColor));
            sigma.tools.drawRoundRect(
                b,
                Math.round(a.displayX - d / 2 - 2),
                Math.round(a.displayY - d / 2 - 2),
                Math.round(
                    b.measureText(a.label).width +
                        1.5 * a.displaySize +
                        d / 2 +
                        4
                ),
            ...
            b.beginPath();
            b.fillStyle =
                'node' == j.p.nodeBorderColor
                    ? a.color || j.p.defaultNodeColor
                    : j.p.defaultNodeBorderColor;
            b.arc(
                Math.round(a.displayX),
                Math.round(a.displayY),
                a.displaySize + j.p.borderSize,
                0,
                2 * Math.PI,
                !0
            );
            ...
            b.beginPath();
            b.fillStyle =
                'node' == j.p.nodeActiveColor
                    ? a.color || j.p.defaultNodeColor
                    : j.p.defaultNodeActiveColor;
            b.arc(
                Math.round(a.displayX),
                Math.round(a.displayY),
                a.displaySize,
            ...
            b.fill();
            b.fillStyle =
                'node' == j.p.labelActiveColor
                    ? a.color || j.p.defaultNodeColor
                    : j.p.defaultLabelActiveColor;
            b.fillText(
                a.label,
    ...
    function t(b, v) {
        function h() {
            sigma.chronos
                .removeTask('node_' + a.id, 2)
                .removeTask('edge_' + a.id, 2)
                .removeTask('label_' + a.id, 2)
                .stopTasks();
            return a;
        }
        function c(b, c) {
            ...
            'undefined' != typeof G_vmlCanvasManager &&
                'canvas' == c &&
                (d = G_vmlCanvasManager.initElement(d));
            a.domElements[b] = d;
        ...
        function d() {
            a.p.drawHoverNodes &&
                (a.graph.checkHover(a.mousecaptor.mouseX, a.mousecaptor.mouseY),
                (a.domElements.mouse.style.cursor = 'default'),
                a.graph.nodes.forEach(function (b) {
                    b.hover &&
                        !b.active &&
                        ((a.domElements.mouse.style.cursor = 'pointer'),
                        a.plotter.drawHoverNode(b));
                }));
            return a;
        }
        function s() {
        ...
        this.mousecaptor
            .bind('drag interpolate', function () {
                a.draw(
                    a.p.auto ? 2 : a.p.drawNodes,
                    a.p.auto ? 0 : a.p.drawEdges,
                    a.p.auto ? 2 : a.p.drawLabels,
                    a.p.auto ? 2 : a.p.drawBG,
                    !0
                );
            })
            ...
            .bind('mousedown mouseup', function (b) {
                ...
                c.length &&
                    a.dispatch(
                        'mousedown' == b.type ? 'downnodes' : 'upnodes',
                        c
                    );
            })
            .bind('move', function () {
                a.contexts.hover.clearRect(
                    0,
                    0,
                    a.domElements.hover.width,
                    a.domElements.hover.height
                );
                d();
                s();
            });
        ...
        this.draw = function (b, c, d, f, i) {
            ...
            h();
            a.graph
                .rescale(a.width, a.height, 0 < b, 0 < c, 0 < f)
                .setBorders();
            a.mousecaptor.checkBorders(a.graph.borders, a.width, a.height);
            a.graph.translate(
                a.mousecaptor.stageX,
                a.mousecaptor.stageY,
                a.mousecaptor.ratio,
                0 < b,
                0 < c,
                0 < f
            ...
            for (var g in a.domElements)
                'canvas' == a.domElements[g].nodeName.toLowerCase() &&
                    (void 0 == i[g] || 0 <= i[g]) &&
                    a.contexts[g].clearRect(
                        0,
                        0,
                        a.domElements[g].width,
                        a.domElements[g].height
                    );
            ...
            i = !1;
            if (f)
                if (1 < f) for (; a.plotter.task_drawBG(); );
                else
                    sigma.chronos.addTask(
                        a.plotter.task_drawBG,
                        'bg_' + a.id,
                        !1
                    ),
                        (i = !0),
                        (g = 'bg_' + a.id);
            if (b)
                if (1 < b) for (; a.plotter.task_drawNode(); );
                else
                    sigma.chronos.addTask(
                        a.plotter.task_drawNode,
                        'node_' + a.id,
                        !1
                    ),
                        (i = !0),
                        (g = 'node_' + a.id);
            if (d)
                if (1 < d) for (; a.plotter.task_drawLabel(); );
                else
                    g
                        ? sigma.chronos.queueTask(
                              a.plotter.task_drawLabel,
                              'label_' + a.id,
                              g
                          )
                        : sigma.chronos.addTask(
                        ...
                        (g = 'label_' + a.id);
            if (c)
                if (1 < c) for (; a.plotter.task_drawEdge(); );
                else
                    g
                        ? sigma.chronos.queueTask(
                              a.plotter.task_drawEdge,
                              'edge_' + a.id,
                              g
                          )
                        : sigma.chronos.addTask(
        ...
        this.resize = function (b, c) {
            ...
            void 0 != b && void 0 != c
                ...
                : ((a.width = a.domRoot.offsetWidth),
                  (a.height = a.domRoot.offsetHeight));
            if (d != a.width || f != a.height) {
                for (var h in a.domElements)
                    a.domElements[h].setAttribute('width', a.width + 'px'),
                        a.domElements[h].setAttribute(
                            'height',
                            a.height + 'px'
                        );
    ...
    function s(b) {
        ...
        this.zoomTo = function (h, c, d) {
            d = Math.min(
                Math.max(b.mousecaptor.config('minRatio'), d),
                b.mousecaptor.config('maxRatio')
            );
            d == b.mousecaptor.ratio
                ? b.mousecaptor.interpolate(
                      h - b.width / 2 + b.mousecaptor.stageX,
                      c - b.height / 2 + b.mousecaptor.stageY
                  )
                : b.mousecaptor.interpolate(
                      (d * h - (b.mousecaptor.ratio * b.width) / 2) /
                          (d - b.mousecaptor.ratio),
                      (d * c - (b.mousecaptor.ratio * b.height) / 2) /
                          (d - b.mousecaptor.ratio),
                      d
                  );
            return g;
        ...
        this.pushGraph = function (h, c) {
            h.nodes &&
                h.nodes.forEach(function (d) {
                    d.id &&
                        (!c || !b.graph.nodesIndex[d.id]) &&
                        g.addNode(d.id, d);
                });
            h.edges &&
                h.edges.forEach(function (d) {
                    (validID = d.source && d.target && d.id) &&
                        (!c || !b.graph.edgesIndex[d.id]) &&
                        g.addNode(d.id, d.source, d.target, d);
                });
            return g;
        };
    ...
    sigma.chronos = new (function () {
        ...
        function f() {
            Object.keys(p).length
                ? (l.dispatch('startgenerators'),
                  l.unbind('killed', k),
                  b(function () {
                      for (var a in p) (p[a].on = !0), i(p[a].task, a, !1);
                  }),
                  l.bind('killed', k).runTasks())
                : l.dispatch('stopgenerators');
            return l;
        }
        function k(b) {
            void 0 != p[b.content.taskName] &&
                (p[b.content.taskName].del || !p[b.content.taskName].condition()
                    ? delete p[b.content.taskName]
                    : (p[b.content.taskName].on = !1),
                0 == a(!0) && f());
        }
        sigma.classes.EventDispatcher.call(this);
        var l = this,
        ...
        this.queueTask = function (a, b, c) {
            if ('function' != typeof a)
                throw Error('Task "' + b + '" is not a function');
            if (
                !r.concat(z).some(function (a) {
                    return a.taskName == c;
                })
            )
                throw Error(
                    'Parent task "' + c + '" of "' + b + '" is not attached.'
                );
            z.push({
                taskParent: c,
                taskName: b,
        ...
        this.removeTask = function (a, b) {
            if (void 0 == a)
                ...
                r = r.filter(function (b) {
                    return (
                        'string' == typeof a ? b.taskName == a : b.task == a
                    )
                        ? ((c = b.taskName), !1)
                        : !0;
                });
    ...
    sigma.tools.rgbToHex = function (b, g, h) {
        return (
            sigma.tools.toHex(b) + sigma.tools.toHex(g) + sigma.tools.toHex(h)
        );
    };
